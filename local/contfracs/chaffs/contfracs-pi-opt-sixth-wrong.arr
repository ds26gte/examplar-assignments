...
#| chaff (tdelvecc, Sep 1, 2020): 
    Defines a sixth coeff for pi, but incorrectly.
...
# CHAFF DIFFERENCE: Only defines the first four coeffs of pi.
cf-pi-opt :: Stream<Option<Number>> = terminating-stream([list: 3, 7, 15, 1, 292, 3])
