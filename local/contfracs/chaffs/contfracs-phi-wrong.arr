...
#| chaff (tdelvecc, Sep 1, 2020): 
    Define phi incorrectly after 3 coeffs.
...
# CHAFF DIFFERENCE: Defines phi incorrectly after 3 coeffs.
cf-phi :: Stream<Number> = 
  lz-link(1, {(): lz-link(1, {(): lz-link(1, {(): repeating-stream([list: 2])})})})
cf-phi-opt :: Stream<Option<Number>> = repeating-stream([list: some(1)])
